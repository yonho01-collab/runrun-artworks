const artworks = [
  {
    ...
    summary: "像一面小小展墙，把陈巫润不同方向的作品集中呈现出来。",
    description:
      "这张总览图把设计图、线描、建筑、游乐场、校园标识、参观记录和农民画主题放在同一个页面里。它不是单幅创作，而像一次迷你展览的入口，让观众先看到作品之间的关系。",
    interpretation:
      "从总览可以看出，陈巫润的兴趣不只在一种画法里。他会画想象中的工具，也会画真实校园和城市；会用黑白线条处理树，也会用明亮色块表现鱼和游乐场。",
    highlight:
  ...
  },
  {
    ...
    interpretation:
      "这幅作品很像一个小工程师的草图。陈巫润把“凉爽”这件事拆成许多功能：吹风、转向、供电、喷雾、控制和放置。文字标注与箭头让观众能顺着他的思路阅读。",
    highlight:
  ...
  },
  {
    ...
    interpretation:
      "班级名片不只是写名字，它需要表达一个集体的精神。陈巫润用圆形构图把信息收拢起来，再用旗帜边缘增加仪式感，使这张作品像一枚属于三七班的小徽章。",
    highlight:
  ...
  },
  {
    ...
    interpretation:
      "这张不是普通的画，而是一份视觉笔记。陈巫润把参观过程中听到、看到、想到的信息重新组织起来，用圈线连接，让知识像地图一样展开。",
    highlight:
  ...
  },
  {
    ...
    interpretation:
      "农民画常常重视鲜明色彩、装饰感和生活气息。陈巫润抓住了这种热闹明快的特点，把鱼画得饱满、快乐，也让水面充满童话感。",
    highlight:
